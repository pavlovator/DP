...
batch_size = 128
num_epochs = 200
train_val_splits = [1050, 238] #lengths of splits to be produced

train_set, val_set = torch.utils.data.random_split(ScaledDataset("uniform_train/*", width=100), train_val_splits)
